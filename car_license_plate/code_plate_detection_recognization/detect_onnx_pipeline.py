...
if __name__ == '__main__':
    ...
    parser.add_argument('--detect_weights', nargs='+', type=str,
                        default=r"F:\\code\\AidLux\\car_license_plate\\code_plate_detection_recognization\\weights\\yolov5_best.onnx",
                        help='detection model path(s)')
    parser.add_argument('--classifi_weights', nargs='+', type=str,
                        default=r"F:\\code\\AidLux\\car_license_plate\\code_plate_detection_recognization\\weights\\LPRNet_Simplified.onnx",
