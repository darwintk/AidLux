...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r"F:\\code\\AidLux\\car_license_plate\\code_plate_detection_recognization\\runs\\Feb27_14-59-12_ubuntu\\weights\\best.pt", help='weights path')
