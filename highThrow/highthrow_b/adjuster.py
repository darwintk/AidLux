...
class Adjuster:
    def __init__(self, start_image, edge=(60, 20)):
        ...
        self.edge = edge # edge是什么 (120, 60)
        self.descriptor = cv2.ORB_create() # ORB特征提取
        self.matcher = cv2.DescriptorMatcher_create("BruteForce") # 暴力匹配
    ...
    def detectAndDescribe(self, image):
        ...
        (kps, features) = self.descriptor.detectAndCompute(image, None) # get keypoints and features
